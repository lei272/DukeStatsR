...
StepAIC works by removing variables backward one by one based on the calculated AIC (Akaike’s Information Criterion). The result shows that **all the 5 explanatory variables used in the original formula are statistically significant predictors**.
