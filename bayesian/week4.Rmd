...
ggplot(m_wage_iq, aes(x=.fitted, y=.resid)) + geom_point() + geom_hline(yintercept=0, linetype="dashed")
hist(m_wage_iq$resid)
```
...
```{r log-resid}
# type your code for the Exercise here, and Knit
hist(m_lwage_iq$resid)
ggplot(m_lwage_iq, aes(x=.fitted, y=.resid)) + geom_point() + geom_hline(yintercept=0, linetype="dashed")
```
